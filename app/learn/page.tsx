...
import { BudgetCalculator } from "@/components/education/budget-calculator"
              ...
              <div className="relative bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20">
                <div className="space-y-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-sm font-medium text-green-600 dark:text-green-400">Financial Education</span>
                  </div>
                  ...
                  <p className="text-xl text-slate-600 dark:text-slate-300 font-medium">
                    Build your financial literacy and develop smart money habits
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="relative">
                ...
                <div className="relative bg-white/40 dark:bg-slate-900/40 backdrop-blur-sm rounded-2xl p-2">
                  <TabsList className="grid w-full grid-cols-2 bg-transparent">
                    <TabsTrigger value="tips" className="data-[state=active]:bg-white/80 dark:data-[state=active]:bg-slate-800/80">Tips & Resources</TabsTrigger>
                    <TabsTrigger value="calculator" className="data-[state=active]:bg-white/80 dark:data-[state=active]:bg-slate-800/80">Budget Calculator</TabsTrigger>
                  </TabsList>
                </div>
              </div>
