...
import { VendorRequest } from "@/components/vendors/vendor-request"
        ...
        <main className="flex-1 container mx-auto px-6 py-10 pb-24 md:pb-10">
          <div className="space-y-10">
            ...
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-24 h-24 bg-gradient-to-br from-orange-400/20 to-red-400/20 rounded-full blur-xl"></div>
              <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-gradient-to-br from-blue-400/20 to-purple-400/20 rounded-full blur-xl"></div>
              ...
              <div className="relative bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20">
                <div className="space-y-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-sm font-medium text-orange-600 dark:text-orange-400">Vendor Network</span>
                  </div>
                  <h1 className="text-5xl font-bold text-balance bg-gradient-to-r from-slate-900 via-orange-900 to-red-900 dark:from-slate-100 dark:via-orange-100 dark:to-red-100 bg-clip-text text-transparent leading-tight">
                    Authorized Vendors
                  </h1>
                  <p className="text-xl text-slate-600 dark:text-slate-300 font-medium">
                    Discover trusted vendors and request new partnerships
                  </p>
                </div>
              </div>
            </div>
            ...
            <Tabs defaultValue="directory" className="space-y-8">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-orange-500/5 to-red-500/5 rounded-2xl blur-sm"></div>
                <div className="relative bg-white/40 dark:bg-slate-900/40 backdrop-blur-sm rounded-2xl p-2">
                  <TabsList className="grid w-full grid-cols-2 bg-transparent">
                    <TabsTrigger value="directory" className="data-[state=active]:bg-white/80 dark:data-[state=active]:bg-slate-800/80">Vendor Directory</TabsTrigger>
                    <TabsTrigger value="request" className="data-[state=active]:bg-white/80 dark:data-[state=active]:bg-slate-800/80">Request Vendor</TabsTrigger>
                  </TabsList>
                </div>
              </div>
